...
const CompanyPartner = () => {
  return (
    <div className='pt-[6rem] pb-[3rem] bg-gradient-to-r from-transparent to-primary-100'>
      <div className=''></div>
        ...
        <div className='flex justify-center gap-[1.5rem] mt-[2rem] bg-gradient-to-r from-transparent to-primary-100 text-clip text-center w-[100%] mx-auto'>
