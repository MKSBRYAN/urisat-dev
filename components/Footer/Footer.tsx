...
const Footer = () => {
  ...
  return (
    <footer className="h-[20%] justify-center items-center bg-black-1 text-primary-50">
      <div className="relative top-0 left-0 overflow-hidden w-full">
        ...
        >
          <path
            ...
            className="relative fill-primary-700"
          ></path>
        </svg>
        <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5 justify-center items-center -mt-[90px]  p-20">
          <div className="flex flex-col mt-5">
            ...
            <p>
              Empowering the Future with Blockchain Technology At{" "}
              <h1 className="text-[16px] md:text-[25px] font-bold text-primary-50">
                <span className="text-[27px] md:text-[40px] text-primary-700 ">
                  U
                </span>
                risat
              </h1>
              , we are pioneering the next wave of innovation in the digital
              landscape. Our mission is to leverage the transformative power of
              blockchain technology to create secure, transparent, and efficient
              solutions for businesses and individuals alike.{" "}
            </p>
          </div>
          <div className="flex flex-col">
            <ul>
              <li className="list-none uppercase font-semibold py-4 text-primary-600">
                Company
              </li>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex space-x-4">
              <a
                className="text-white hover:text-primary-300 transition-all duration-150 ease-in-out transform hover:scale-150"
                href=""
              >
                <FaGithub />
              </a>
        ...
        <div className="mt-20">
          <div className="h-full flex items-center justify-center mb-5">
            <form action="" className="w-96 relative">
              <input
                type="email"
                placeholder="urisat@urisat.dev"
                className="w-full text-gray-800 p-4 h-12 rounded-full focus:outline-none focus:border border-primary-300"
              />
              <button className="bg-primary-700 text-center px-8 py-2 rounded-full text-primary-50 absolute top-0 right-0">
                Submit
              </button>
            </form>
          </div>
